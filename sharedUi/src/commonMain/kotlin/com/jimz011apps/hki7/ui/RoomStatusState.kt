...
fun displayedRoomControlEntityIds(widgets: List<HKIRoomWidget>): Set<String> = buildSet {
...
fun HKIAreaConfig.roomEntityIds(): List<String> = buildList {
...
private val HAEntity.domain: String
    get() = entity_id.substringBefore('.', missingDelimiterValue = "").lowercase()

private val HAEntity.normalizedDeviceClass: String?
    get() = deviceClass?.trim()?.lowercase()
