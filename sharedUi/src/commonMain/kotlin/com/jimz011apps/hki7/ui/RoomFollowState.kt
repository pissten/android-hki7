...
fun roomSlug(value: String): String =
 ...
 */
fun resolveFollowedArea(
    state: String?,
    areas: List<HAArea>,
    follow: Hki7RoomFollow
): String? {
    val raw = state?.trim() ?: return null
    if (raw.lowercase() in AWAY_STATES) return null
 ...
 */
class RoomDwellTracker(private val dwellSeconds: Int) {
